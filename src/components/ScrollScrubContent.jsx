      ...
      <div className="max-w-4xl mx-auto px-8">
        <div className="space-y-16">
          ...
          <div className="space-y-8">
            ...
            <p className="text-xl leading-relaxed">
              <ScrubbingText text="Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo." />
            </p>

            <p className="text-xl leading-relaxed">
              <ScrubbingText text="Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet." />
            </p>

            <p className="text-xl leading-relaxed">
              <ScrubbingText text="At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint occaecati cupiditate non provident." />
            </p>

            <p className="text-xl leading-relaxed">
              <ScrubbingText text="Et harum quidem rerum facilis est et expedita distinctio. Nam libero tempore, cum soluta nobis est eligendi optio cumque nihil impedit quo minus id quod maxime placeat facere possimus." />
            </p>
          </div>
        </div>
      </div>
